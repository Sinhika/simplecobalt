    ...
    public void EntityJoinWorldEvent(EntityJoinWorldEvent event)
    {
    	...
    	if (rand <= 0.02D)
        {
            ...
            if (range == 21)
            {
                ...
                living.setCurrentItemOrArmor(3, new ItemStack(SimpleCobaltCore.blueCeladonChest));
                living.setCurrentItemOrArmor(2, new ItemStack(SimpleCobaltCore.blueCeladonLegs));
                living.setCurrentItemOrArmor(1, new ItemStack(SimpleCobaltCore.blueCeladonBoots));
            ...
            if (range == 27)
            {
                living.setCurrentItemOrArmor(0, new ItemStack(SimpleCobaltCore.blueCeladonShovel));
            }

            if (range == 28)
            {
                living.setCurrentItemOrArmor(0, new ItemStack(SimpleCobaltCore.blueCeladonAxe));
            }

            if (range == 29)
            {
                living.setCurrentItemOrArmor(0, new ItemStack(SimpleCobaltCore.blueCeladonPickaxe));
            }

            if (range == 30)
            {
                living.setCurrentItemOrArmor(0, new ItemStack(SimpleCobaltCore.blueCeladonHoe));
            }
